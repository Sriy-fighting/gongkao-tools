(function () {
  ...
  function initKnowledgeLibrary() {
    var fallback = { maps: [{ id: 'science-section-1', title: '科技常识：波、电磁波与光学', subtitle: '声音、波动、电磁波、光学现象与成像', path: '../常识思维导图/科技常识_第一节_学习增强版.html', icon: '科', color: '#2783c9', order: 1, nodes: [] }, { id: 'science-section-2', title: '科技常识：力学、电学与能量', subtitle: '牛顿定律、常见力、电学现象、能量守恒与核能', path: '../常识思维导图/科技常识_第二节_学习增强版.html', icon: '力', color: '#2778b8', order: 2, nodes: [] }, { id: 'history-section-3', title: '历史常识：东汉至隋朝', subtitle: '东汉、三国、两晋南北朝与隋朝历史脉络', path: '../常识思维导图/历史常识_第三节_学习增强版.html', icon: '史', color: '#a34d37', order: 3, nodes: [] }] };
