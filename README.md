...
| **速算练习** | 乘法百化分速算训练，练习与复习双模式，错题自动重做 |
| **复习安排** | 艾宾浩斯复习计划，学习项目记录，自动排期，导入导出 |
| **常识50天** | 50天常识新学与节点复习，遮答案自测，进度打卡 |
...
公考工具箱内置“政治常识复盘”，用于政治理论与常识的逐题阅读、来源证据、答题历史和间隔复习。资料位于 tools/公考工具箱/reviews/：
